...
var TYPE_LIBRARY = {
  CTRL: { code: 'ALFA', cn: '边界总设计师', intro: '规则先立，安全先行。', desc: '你属于“先把规则讲明白再谈浪漫”的类型。遇到模糊关系会主动拉线，怕的不是争吵，而是没边界导致反复内耗。你在爱里追求可持续，不爱情绪赌博。别人会觉得你理性过头，但真正懂你的人知道，你的克制其实是对关系最深的负责。' },
  'ATM-er': { code: 'GIFT', cn: '务实宠爱官', intro: '爱是可兑现的细节。', desc: '你不爱空话，喜欢把在意落实成“看得见摸得着”的照顾。礼物、实用、记住对方偏好，这些在你眼里都不是表演，而是关系里的稳定输出。你不一定最会说情话，却很会在关键时刻补位。你的浪漫像日常供电，安静但不断电。' },
  'Dior-s': { code: 'LAZY', cn: '松弛感伴侣', intro: '不折腾，但不敷衍。', desc: '你对恋爱的理解偏松弛：不硬凹仪式，不为小事上头，能过就过，能笑就笑。你看起来“都行”，但不是摆烂，而是把精力放在真正重要的事上。你擅长让关系降噪，少一点内耗，多一点呼吸感。' },
  BOSS: { code: 'KING', cn: '现实掌舵者', intro: '谈爱，也谈落地。', desc: '你在关系中有明显的“掌舵倾向”，重视现实可行性、长期规划和执行力。你不喜欢情绪空转，遇到问题会倾向先定方案再修关系。你的优势是稳、准、扛事，短板是偶尔忘了柔软表达。学会在计划里留点温度，你会更无敌。' },
  'THAN-K': { code: 'AWWW', cn: '温柔经营派', intro: '爱在细节里回响。', desc: '你相信关系不是靠一次心动，而是靠长期经营。你会看见对方的努力，愿意给予回应和鼓励。你对“互相站位思考”有天然天赋，吵架也尽量不伤人。你不是最炸裂的恋人，却是最让人想长期相处的人。' },
  'OH-NO': { code: 'ALRM', cn: '风险预警员', intro: '我不是多想，我是在防翻车。', desc: '你对异常信号极其敏感：句号、已读不回、语气变化都能触发预警。你不是不爱，而是怕再受伤，所以会先防御再靠近。你的判断力很强，但容易把“可能”当“事实”。如果你能把脑内推演换成当面沟通，关系质量会明显提升。' },
  GOGO: { code: 'RUSH', cn: '即兴行动派', intro: '走啊，别等气氛。', desc: '你在爱里偏即兴，喜欢说走就走、边走边看。你把关系里的新鲜感拉满，能把普通周末过出旅行感。你不怕变化，甚至享受变化。只要补一点稳定承诺，你会是“有趣又可靠”的稀缺型伴侣。' },
  SEXY: { code: 'GLOW', cn: '心动触发器', intro: '你负责让第一眼有电。', desc: '你很懂“心动感”的价值，氛围和化学反应在你这里很重要。你会被感觉打动，也很会制造感觉。你不是肤浅，而是相信情绪真实。只是当热度过去后，别忘了补上长期经营的能力，关系才会从好看变耐用。' },
  'LOVE-R': { code: 'BARD', cn: '浪漫理想派', intro: '愿意相信爱这件事。', desc: '你对爱情保有诗意和期待，即使看过现实，也愿意给真心二次机会。你重视心动和仪式，愿意把平淡日子过成纪念日。你可能会偶尔理想化关系，但你也有强大的修复力。你的存在，能让别人重新相信温柔。' },
  MUM: { code: 'CARE', cn: '共情照护者', intro: '我先接住你，再谈对错。', desc: '你擅长在关系里做情绪缓冲垫。对方低落时你先安抚，冲突时你先降温。你很会“看见人”，也很会给安全感。要注意的是，别把自己长期放在第二位；真正健康的亲密，也需要你被照顾。' },
  FAKE: { code: 'MASK', cn: '情境切换者', intro: '我会看场合说话。', desc: '你对关系场景变化适应力很强，知道什么时候该直接、什么时候该留白。你不是虚伪，而是高情商防碰撞。你的优势是“稳定过关”，风险是“真实表达不足”。当你愿意袒露脆弱，亲密度会大幅上升。' },
  OJBK: { code: 'CHLL', cn: '低内耗伴侣', intro: '能过就过，不硬刚。', desc: '你在恋爱里很少为小事起冲突，包容度高，情绪阈值也高。你更关注整体关系是否舒适，而不是每一回合输赢。你像关系里的减震器。唯一要注意：关键问题别总“算了”，该表达时要表达。' },
  MALO: { code: 'MONY', cn: '轻喜剧恋人', intro: '恋爱也要有好玩的部分。', desc: '你擅长让关系不无聊，能把平凡瞬间变成笑点。你有梗、有松弛、有感染力，适合长期相处中的“情绪保鲜”。别人的烦恼在你这儿常常会被化解成可处理的问题。只要你愿意在认真时更坚定，关系会更稳更深。' },
  'JOKE-R': { code: 'CLOW', cn: '嘴硬撒娇怪', intro: '嘴上打岔，心里在意。', desc: '你对“分手”等重话有时会嘴快，其实更多是情绪表达和撒娇试探。你并不想真的结束，只是希望被重视、被确认。你在关系里很有戏感，但也容易被误读。学会把“试探”改成“直说”，你会少走很多弯路。' },
  'WOC!': { code: 'WOAH', cn: '戏剧感雷达', intro: '我直觉很准，也很会联想。', desc: '你对关系张力很敏感，容易快速捕捉到不对劲。你的直觉常常有用，但也容易放大焦虑。你适合有透明沟通和稳定回应的关系。被认真解释时你会很快软下来，因为你要的从来不是控制，而是确定。' },
  'THIN-K': { code: 'MIND', cn: '理性校准师', intro: '先想清楚，再决定。', desc: '你会对关系做结构化思考：现实条件、价值观、长期可行性都要过审。你不是冷，而是怕把感情用在错误方向。你很会复盘和修正，适合长期主义关系。偶尔给感性留个窗口，会让你更可亲也更幸福。' },
  SHIT: { code: 'SPCY', cn: '情绪爆点型', intro: '生气来得快，心软也快。', desc: '你在冲突场景里情绪启动速度快，容易在高压下说重话。可你并不坏，你只是表达方式偏猛。你真正需要的是“先降温再沟通”的流程。掌握节奏后，你会从关系里的风暴，变成关系里的推进器。' },
  ZZZZ: { code: 'SLEP', cn: '安静宅系派', intro: '不吵不闹，但有温度。', desc: '你偏好低刺激相处：安静、熟悉、可持续。你不追求天天轰烈，更看重“舒服地在一起”。你在关系里像慢火，热得慢，但稳定耐久。遇到理解你节奏的人，你会给出很长很稳的陪伴。' },
  POOR: { code: 'FOCS', cn: '长期务实派', intro: '别空想，先看能不能走远。', desc: '你对关系有现实判断力：三观、经济、家庭协同都要考虑。你不是功利，而是珍惜彼此时间，不愿意无效消耗。你擅长筛选“能长期共建的人”。在你这里，爱不是冲动，而是可兑现的长期合作。' },
  MONK: { code: 'ZENN', cn: '边界清修派', intro: '亲密要有，空间也要有。', desc: '你对个人空间和边界有刚需，不爱高频黏连，也不喜欢被过度盘问。你更相信“日常稳定”胜过“高频证明”。你的关系观成熟且清醒。只要对方尊重边界，你会给出非常稳的信任。' },
  IMSB: { code: 'WAVR', cn: '焦虑摇摆体', intro: '想要确定，又怕被伤。', desc: '你在爱里容易两头拉扯：想靠近，又怕失控；想相信，又怕落空。你不是矫情，是安全感阈值更高。你适合节奏稳定、沟通透明的关系。被好好回应时，你会非常忠诚且投入。' },
  SOLO: { code: 'HEDG', cn: '敏感防御派', intro: '我在意，所以我防御。', desc: '你最怕的是“慢慢冷掉”或“误会累积”，因此会提前防御。你对冷暴力、敷衍、失联容忍度很低。你不是难搞，你只是很怕真心被轻拿轻放。遇到愿意持续沟通的人，你会慢慢松刺，变得很软。' },
  FUCK: { code: 'WILD', cn: '自由野生派', intro: '我爱自由，也爱真诚。', desc: '你不喜欢关系被写成死板流程，更偏爱真实、松弛、有生命力的相处方式。你会给彼此空间，也尊重个体成长。你的底线是别欺骗、别消耗。你适合信任度高、控制欲低的关系生态。' },
  DEAD: { code: 'CALM', cn: '冷静体面派', intro: '能爱得热烈，也能退得体面。', desc: '你对结局看得通透：能走到最后就珍惜，走不到也不撕扯。你重视过程真诚，反感拉扯消耗。你不是冷血，是成熟。你的爱像一条稳线，不喧哗，但很有分量。' },
  IMFW: { code: 'SOFT', cn: '情绪海绵体', intro: '我很容易被细节打动。', desc: '你对细节很敏感，小小的在意就能让你开心很久，小小的忽略也会让你失落。你是高感知型恋人，真诚且柔软。你最需要的是明确偏爱和稳定回应。被好好对待时，你会回馈超额温柔。' },
  HHHH: { code: 'LOLP', cn: '抽象混沌体', intro: '你的恋爱脑回路，不走寻常路。', desc: '当你的选择同时命中多种相反倾向时，系统会把你归到这个类型。你不是“有问题”，你只是复杂、流动、很难被单一标签概括。你的优势是弹性与创造力，建议在关键议题上建立稳定表达，关系会更顺。' },
  DRUNK: { code: 'TIPS', cn: '停用占位类型', intro: '此类型已停用。', desc: '隐藏题已移除，本类型仅作历史兼容占位，不再参与常规结果判定。' }
};
